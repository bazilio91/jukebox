...
module.exports = function (grunt) {
    ...
    grunt.loadTasks(depsPath + '/grunt-/tasks');
            ...
            compile: {
                options: {
                    ...
                    processName: function (filename) {
                        return filename.replace('assets/js/templates/', '').replace('.ejs', '');
                    }

                },
                files: {
                    '.tmp/public/js/templates.js': ['assets/js/templates/**/*.ejs']
                }
            }
        },
